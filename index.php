...
<body>
    ...
    <div class="popup-container" id="register-popup">
        <div class="register popup">
            <form action="login_register.php" method="POST">
                ...
                <input type="password" placeholder="Password"  name="password" required>
                <button type="submit" class="register-btn" name="register">Submit</button>
            </form>
        </div>
    </div>
    ...
    <!-- ----------  Home --------------------- -->
    <section id="home">
        <h1 class="h1">Welcome to Resort Management System</h1>
    ...
    <section id="footer" class="section footer">
        <div class="container">
            <div class="footer-container">
                ...
                <div class="footer-center">
                    <h3>CONTACT INFO</h3>
                    <p>Kopargaon,Ahemadnagar <br>Maharashtra,Pin-423301 <br>+91 9130556147 <br></p>
                    <p> <a href ="https://in.search.yahoo.com/search?fr=mcafee&type=E210IN826G91648&p=restaurants+near+me">www.resort.com</p>
                </div>
                <div class="footer-center">
                    <h3>OPENING HOURS</h3>
                    <div>
